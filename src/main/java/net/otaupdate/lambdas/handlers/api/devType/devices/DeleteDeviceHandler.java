...
{
	private static final String ERR_STR = "error deleting device";
	...
	{	
		...
		if( !userIn.hasPermissionForDevice(this.orgUuid, this.devTypeUuid, this.devSerialNumber, dslContextIn) ) throw new BreakwallAwsException(ErrorType.BadRequest, ERR_STR);
